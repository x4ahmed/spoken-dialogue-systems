...
from convlab.util.simplemultiwoz21.state import default_state_old as default_state
...
if __name__ == '__main__':
    ...
    dst.init_session()
    action = [["Inform", "Restaurant", "Food", "italian"]]
    state = dst.update(action)
                     ...
                     'belief_state': {
                                      'hotel': {'book': {'booked': [], 'people': '', 'day': '', 'stay': ''},
                                                'semi': {'name': '',
                                                         ...
                                                         'type': ''}},
                                      'restaurant': {'book': {'booked': [], 'people': '', 'day': '', 'time': ''},
                                                     'semi': {'food': 'italian', 'pricerange': '', 'name': '', 'area': ''}}
                                      },
                     'request_state': {},
                     'terminated': False,
                     'history': []}
