...
from convlab.util.custom_util import create_goals
...
class UserPolicyAgendaMultiWoz(Policy):
    ...
    def __init__(self):
        ...
        self.goals = create_goals(
            self.goal_generator,
            num_goals=100,
            single_domains=False,
            allowed_domains=["restaurant", "hotel"],
        ) 
    ...
    def __init__(self, goal: Goal):
        ...
        for idx in range(len(goal.domains) - 1, -1, -1):
            ...
            if 'fail_info' in goal.domain_goals[domain]:
                for slot in random_sample(list(goal.domain_goals[domain]['fail_info'].keys()),
                ...
                for slot in random_sample(list(goal.domain_goals[domain]['info'].keys()),
