...
INFORMABLE_SLOTS = ["Addr", "Area", "Stars", "Internet", "Choice", "Ref", "Food", "Type", "Price", \
                    "Stay", "Phone", "Post", "Day", "Name", "Time", None, \
                    "People", "Parking", "Id"]

REQUESTABLE_SLOTS = ['Food', 'Area', 'Price', 'Type', 'Internet', 'Parking', 'Stars', 'Type']

# Information required to finish booking, according to different domain.
booking_info = {'Restaurant': ['Time', 'Day', 'People'],
