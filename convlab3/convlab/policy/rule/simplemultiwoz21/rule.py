...
from convlab.policy.rule.simplemultiwoz21.rule_based_multiwoz_bot import RuleBasedMultiwozBot
from convlab.policy.rule.simplemultiwoz21.policy_agenda_multiwoz import UserPolicyAgendaMultiWoz
